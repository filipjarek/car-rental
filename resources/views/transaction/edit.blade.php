<x-app-layout>
            ...
            <nav class="flex px-5 py-3 text-gray-700  rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300  dark:border-gray-700" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            <svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                            <span class="ml-1 text-sm font-medium text-gray-900 md:ml-2 dark:text-gray-100">{{ __('Transaction Information') }}</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-2 -mx-3 md:flex  underline ">{{ __('Customer Information') }}</div>
        ...
        <div class="p-2 -mx-3 md:flex  underline ">{{ __('Vehicle Information') }}</div>
        ...
        <div class="p-2 -mx-3 md:flex  underline  ">{{ __('Transaction Information') }}</div>
        <div class="-mx-3 md:flex mb-2 ">
            <div class="md:w-1/2 px-3 mb-6">
